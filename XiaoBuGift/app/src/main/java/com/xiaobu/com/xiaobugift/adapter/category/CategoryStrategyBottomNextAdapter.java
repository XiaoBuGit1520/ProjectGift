 ...
 * (从HomeUseFragment复制并更换实体类)
 */

public class CategoryStrategyBottomNextAdapter extends BaseAdapter {

    private CategoryStrategyBottomNextData data;
    private Context context;

    public CategoryStrategyBottomNextAdapter(Context context) {
        this.context = context;
    }

    public void setData(CategoryStrategyBottomNextData data) {
        this.data = data;
