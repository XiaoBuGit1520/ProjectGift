...
public class HomeGlideAdapterNext extends BaseAdapter {

    private HomeGlideDataNext data;
    private Context mContext;

    public HomeGlideAdapterNext(Context context) {
        mContext = context;
    }

    public void setData(HomeGlideDataNext data) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_home_glide_next, parent, false);
